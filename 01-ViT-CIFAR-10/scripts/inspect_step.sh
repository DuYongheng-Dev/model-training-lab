#!/usr/bin/env bash
# One optimizer update plus a separate gradient accumulation observation.
set -euo pipefail
...
[[ $# -eq 0 ]] || { printf '%s\n' 'Usage: bash scripts/inspect_step.sh' >&2; exit 2; }
