...
1. 第 40 步 accuracy 已是 100%，为什么 loss 还能从约 0.442 降到 0.037？
2. 这 32 张图全部预测正确，能否说明模型在没见过的 CIFAR-10 图片上也能达到 100%？为什么？
3. 本实验每步使用同一批 32 张图，训练 150 步后，模型见到了多少张不同图片，完成了多少次参数更新？
